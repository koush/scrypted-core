...
export default {
  ...
  data() {
    const componentWebPath = this.getComponentWebPath("webpush");
    ...
    const inviteCard = {
      ...
      description: "The invite link will expire in 10 minutes. Copy the link and invite a different user or device, or subscribe on this browser.",
