          ...
          <v-layout>
            <v-flex xs12>
              ...
              >
                ...
                <v-card-text class="subtitle-2">{{ result.package.description }}</v-card-text>
                <v-form>
                  <v-container>
                    <v-flex>
                      <v-layout align-center>
                        ...
                        <span
                          class="mx-1"
                        >{{ ' published ' + result.package.version + ' • ' + new Date(result.package.date).toDateString() }}</span>
                      </v-layout>
                    </v-flex>
                  </v-container>
                </v-form>
                <v-card-actions>
                  ...
                  >View on npm</v-btn>
                  <v-btn color="success" @click="install(result.package.name)">Install</v-btn>
                </v-card-actions>
              </v-card>
            </v-flex>
          </v-layout>
